...
### Workflow
По мере использования DBLab Engine Вы неминуемо будете создавать Thin-clones. Для быстрой проверки возможности к ним присоединиться можно использовать обычный Docker образ PostgreSQL:
`docker run -it --rm postgres:17 psql -h dblab2.tail8cb8b9.ts.net -p 6000 -U test -d demo -W` и ввести пароль от юзера на созданном клоне.
